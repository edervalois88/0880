      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          <motion.div 
            ...
            className={`navbar fixed top-0 z-40 transition-all duration-500 ${scrolled ? 'bg-white/90 backdrop-blur-lg shadow-sm h-16 md:h-20' : 'bg-transparent h-20 md:h-24'}`}
          >
            <div className="navbar-start pl-4 md:pl-8">
              <a href="#" className="hidden lg:block hover:opacity-80 transition-opacity">
                <BrandLogo size={60} />
              </a>
              <a href="#" className="lg:hidden font-serif text-xl md:text-2xl font-bold tracking-widest">0880</a>
            </div>
            ...
            <div className="navbar-end pr-4 md:pr-8 flex gap-3 md:gap-6 items-center">
              ...
              <button 
                ...
                className="hidden sm:block text-[10px] uppercase tracking-widest font-bold hover:text-brand-grey transition-colors"
              ...
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#catalog" 
                className="btn btn-outline btn-sm rounded-none border-brand-black text-brand-black hover:bg-brand-black hover:text-white uppercase tracking-widest text-[10px] px-6 md:px-8 py-2 h-auto min-h-0 font-medium transition-colors hidden md:flex"
              >
                {t.nav.shop}
              </motion.a>
              ...
              <button
                ...
                className="lg:hidden p-2 hover:bg-brand-black/5 rounded-md transition-colors"
            ...
            <div className="relative z-10 text-center text-white w-full max-w-5xl px-4 mt-20">
              ...
              >
                <div className="overflow-hidden mb-4">
                  <motion.h1 variants={fadeUp} className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-serif tracking-tighter leading-[0.85] drop-shadow-2xl mix-blend-overlay opacity-90">
                    {t.hero.title1}
                  </motion.h1>
                </div>
          ...
          {/* Footer */}
          <footer className="bg-[#111] text-brand-grey py-16 md:py-32 px-4 md:px-8 border-t border-white/5 relative overflow-hidden">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12 relative z-10">
              ...
              >
                ...
                <p className="text-xs md:text-sm font-light leading-relaxed tracking-wide opacity-60 pl-2 max-w-xs">
                  {t.footer.text}
                </p>
              </motion.div>
              
              <div className="flex gap-12 sm:gap-16 md:gap-24 text-[10px] uppercase tracking-[0.25em] pt-0 md:pt-4">
